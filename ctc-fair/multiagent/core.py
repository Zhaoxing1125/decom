...
class World(object):
    ...
    def apply_action_force(self, p_force):
        ...
        for i,agent in enumerate(self.agents):
            if agent.movable:
                ...
                #print(i, p_force[i], agent.mass, agent.action.u, noise)
        return p_force
    ...
    def integrate_state(self, p_force):
        for i,entity in enumerate(self.entities):
            #print(i, entity.state.p_pos, entity.state.p_vel, p_force[i])
            ...
            #print(i, entity.state.p_pos, entity.state.p_vel)
